...
export class AlbumsService {
  ...
  // Get all album where rating is more than X
  // getAlbums() {
  //   const rating = 3;

  //   return this.albumsRepository.createQueryBuilder("album").where("album.rating > :rating", { rating }).getMany();
  // }

  // Get all albums whose name start with S that have songs that start with B
  // getAlbums() {
  //   return this.albumsRepository
  //     .createQueryBuilder("album")
  ...
  // Get all album which don't have T in their name
  getAlbums() {
    return this.albumsRepository
      .createQueryBuilder("album")
